...
We analyze as set of 3528 images with exposure times greater than 200s, with (\todo{fill in}) observations of (\todo{fill in}) established main-belt objects from the OSSOS survey telescope. 
